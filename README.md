**Apprendre le vocabulaire et la prononciation de plusieurs groupes d’informations pour les petits enfants, Stéphanie et sa famille**

Sous « Options », il est possible d’afficher les images des mots lorsqu’ils sont cliqués, s’il existe une image associée au mot ou à la mini-phrase.
...
1. Sous « Options », choisir **Importer image**.
2. Cliquer sur le mot auquel vous souhaitez associer une image.
3. En cliquant sur le mot, une mini page web apparaîtra à droite de l’écran, au même niveau que le mot sélectionné.
4. Cliquer sur « Image » dans la mini page web.
5. Choisir une image appropriée.
6. Faire un clic droit sur l’image choisie et sélectionner **« Copier le lien de l’image »** (*Copy image link*).

   * Si cela fonctionne, une boîte verte vide apparaîtra.
   * L’important est que la barre en haut de la mini page web soit verte.
   * Cela signifie que l’image a bien été copiée.
7. Il est recommandé de sauvegarder souvent avec **« Save Json File »**, idéalement après chaque nouvelle image ajoutée.

   * Parfois, lorsqu’il y a trop de nouvelles images, les fichiers se sauvegardent moins bien.
